...
logo3=("""
\033[1;99m╔════════════════════════════════════════════════════════════════════╗    
\033[1;92m█  ______        _     ____  ____   ______  _____  ______    
\033[1;93m█ |_   _ \      / \   |_  _||_  _|.' ___  ||_   _||_   _ `.  
\033[1;94m█   | |_) |    / _ \    \ \  / / / .'   \_|  | |    | | `. \ 
\033[1;95m█   |  __'.   / ___ \    \ \/ /  | |   ____  | |    | |  | | 
\033[1;96m█  _| |__) |_/ /   \ \_  _|  |_  \ `.___]  |_| |_  _| |_.' / 
\033[1;97m█ |_______/|____| |____||______|  `._____.'|_____||______.'                                                           
\033[1;99m╚════════════════════════════════════════════════════════════════════╝
\033[1;94m[+]===============================================================[+]
\033[1;94m[+]\033[1;32m               CREATED BY   :  BAYGID                                       \033[1;94m[+]
\033[1;94m[+]\033[1;32m               ON GITHUB    :  BAYGID                          \033[1;94m[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m BAYGID  SMS WAS SENT🐼")
  else:
    pass
